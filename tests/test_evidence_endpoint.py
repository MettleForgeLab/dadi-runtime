...
def test_evidence_create_requires_scope():
    ...
    r = requests.post(f"{API}/deliverables/00000000-0000-0000-0000-000000000000/evidence", headers={"Authorization": f"Bearer {token}"})
    assert r.status_code in (403, 404, 409, 401)
