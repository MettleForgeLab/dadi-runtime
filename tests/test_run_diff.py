...
def test_runs_diff_endpoint_shape():
    token = make_jwt(JWT_SECRET, {"tenant_id":"tenant_a","scope":"artifact:read_bytes","exp": int(time.time()) + 3600})
    headers = {"Authorization": f"Bearer {token}"}
    r = requests.get(f"{API}/runs/diff", params={"run_a":"00000000-0000-0000-0000-000000000000", "run_b":"00000000-0000-0000-0000-000000000001"}, headers=headers)
